...
import {
  ...
  Figma, Mic, PenTool, MessageSquare, X,
} from 'lucide-react';
          ...
          {isAdmin && (
            <>
              ...
              <div
                ...
                style={{
                  background: activePage === 'admin' ? 'rgba(255,184,0,0.08)' : 'rgba(255,184,0,0.03)',
                  borderColor: activePage === 'admin' ? 'rgba(255,184,0,0.3)' : 'rgba(255,184,0,0.1)',
                }}
              >
                <ShieldCheck size={16} style={{ color: 'var(--accent-amber)' }} />
                <span style={{ color: activePage === 'admin' ? 'var(--accent-amber)' : undefined }}>Admin Panel</span>
                <span className="nav-badge" style={{ background: 'var(--accent-amber)', color: '#000' }}>ADMIN</span>
              </div>
            </>
          )}
